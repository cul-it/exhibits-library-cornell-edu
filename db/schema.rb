...
ActiveRecord::Schema.define(version: 2021_04_19_145902) do
  ...
  create_table "spotlight_attachments", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
    t.string "file"
    t.string "uid"
  ...
  create_table "spotlight_blacklight_configurations", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "exhibit_id"
    t.text "facet_fields"
    t.text "index_fields"
  ...
  create_table "spotlight_contact_emails", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "exhibit_id"
  ...
  create_table "spotlight_contacts", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "slug"
    t.string "name"
    t.string "email"
    t.string "title"
  ...
  create_table "spotlight_custom_fields", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "exhibit_id"
    t.string "slug"
    t.string "field"
  ...
  create_table "spotlight_custom_search_fields", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "slug"
    t.string "field"
    t.text "configuration"
    t.integer "exhibit_id"
  ...
  create_table "spotlight_exhibits", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "spotlight_featured_images", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "type"
    t.boolean "display"
    t.string "image"
    t.string "source"
  ...
  create_table "spotlight_filters", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "field"
    t.string "value"
    t.integer "exhibit_id"
    t.datetime "created_at", null: false
  ...
  create_table "spotlight_languages", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "spotlight_locks", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "on_type"
    t.integer "on_id"
    t.string "by_type"
    t.integer "by_id"
  ...
  create_table "spotlight_main_navigations", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "label"
  ...
  create_table "spotlight_pages", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "title"
    t.string "type"
    t.string "slug"
    t.string "scope"
  ...
  create_table "spotlight_reindexing_log_entries", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "spotlight_resources", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "exhibit_id"
    t.string "type"
    t.string "url"
    t.text "data"
  ...
  create_table "spotlight_roles", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "user_id"
    t.string "role"
  ...
  create_table "spotlight_searches", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "title"
    t.string "slug"
    t.string "scope"
  ...
  create_table "spotlight_sites", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "title"
    t.string "subtitle"
    t.integer "masthead_id"
  end

  create_table "spotlight_solr_document_sidecars", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "exhibit_id"
