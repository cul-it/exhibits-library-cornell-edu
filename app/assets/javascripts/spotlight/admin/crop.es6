// Overrides Crop addImageSelectorToExistingCropTool from blacklight-spotlight gem to add image based on tilesource
// TODO: How to override addImageSelectorToExistingCropTool function only instead of copying over whole class?
